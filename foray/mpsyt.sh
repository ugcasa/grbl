...
mpsyt --ver >>/dev/null || mpsyt.install
...
mpsyt.main () {
    ...
    case "$argument" in
            beer|demo|help|install|upgrade)
                                    mpsyt.$argument $@               ; return 0 ;;
            stop|end)               mpsyt.silence $@                 ; return 0 ;;
            vt|text|ascii)          mpsyt.text $@                    ; return 0 ;;
            api_key)                mpsyt.set_api_key $@             ; return 0 ;;
