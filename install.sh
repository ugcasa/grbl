...
modules_to_install=(mqtt note android print project scan audio display ssh stamp tag timer tor trans user vol yle news program tmux tunnel corsair backup convert telegram cal place)
