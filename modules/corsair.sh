...
# TBD too general global variable name, but GURU_CORSAIR_ prefix is too raw
ESC="/tmp/ckbpipe000"
F1="/tmp/ckbpipe001"
F2="/tmp/ckbpipe002"
F3="/tmp/ckbpipe003"
...
[Service]
ExecStart=bash -c '$HOME/bin/core.sh corsair start'
ExecStop=bash -c '$HOME/bin/core.sh corsair stop'
Type=simple
Restart=always
RemainAfterExit=yes
